...
class HelpView(ui.View):
    ...
    async def interaction_check(self, interaction: Interaction) -> bool:
        if interaction.user.communication_disabled_until is not None:
...
class ThreadCloseView(ui.View):
    ...
    async def interaction_check(self, interaction: Interaction) -> bool:
        ...
        if isinstance(interaction.user, Member) and interaction.user.communication_disabled_until is not None:
            await interaction.send(timeout_message, ephemeral=True)
            return False
