...
# Commented ones are nc ones
HELP_CHANNEL_ID: int = 954805334919237652
# HELP_CHANNEL_ID: int = 881965127031722004
HELP_LOGS_CHANNEL_ID: int = 890674366776475769
# HELP_LOGS_CHANNEL_ID: int = 883035085434142781
HELPER_ROLE_ID: int = 916051595794448396
# HELPER_ROLE_ID: int = 882192899519954944
HELP_MOD_ID: int = 916051618187870280
# HELP_MOD_ID: int = 896860382226956329
GUILD_ID: int = 890673374731321395
...
class TopicDropdown(nextcord.ui.Select):
    def __init__(self):
        ...
        options = [
            ...
            nextcord.SelectOption(
                label="Hosting", description="Any questions related to hosting your bot"
            ),
            nextcord.SelectOption(
                label="Databases",
...
class HelpButton(ui.Button["HelpView"]):
    ...
    async def __launch_wait_for_message(
        ...
        try:
            m: Message = await self.view.bot.wait_for(
